...
interface Veiculo { modelo: string; cor_veiculo: string; }
      ...
      <header className="relative flex items-start justify-between gap-6">
        <div className="flex items-center gap-4 min-w-0">
          <div className="relative shrink-0">
            <div className="h-14 w-14 rounded-2xl bg-gradient-to-br from-[var(--color-primary)]/20 to-transparent border border-[var(--color-primary)]/15 flex items-center justify-center">
              <User size={26} strokeWidth={1.5} className="text-[var(--color-primary-light)]" />
            </div>
          ...
          <div className="flex flex-col gap-2 min-w-0">
            ...
            <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[var(--color-background-subtle)] border border-[var(--color-stroke)] w-fit">
              ...
              <span className="text-[11px] font-semibold text-[var(--color-foreground-muted)] uppercase tracking-wider whitespace-nowrap">
                {viagem.veiculo.modelo} · {viagem.veiculo.cor_veiculo}
              </span>
            </span>
          </div>
        </div>
