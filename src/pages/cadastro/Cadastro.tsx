  ...
  return (
    <>
      <section className="min-h-screen mt-10 flex items-center justify-center bg-gray-light font-sans px-6 py-25 md:px-0">
        <article className="w-full max-w-255 rounded-2xl overflow-hidden shadow-(--shadow-soft) border-1 border-(--color-primary) grid grid-cols-1 md:grid-cols-5">
          <div className="bg-primary- text-white p-6 md:p-10 flex flex-col justify-between md:col-span-2">
            <div className="flex flex-col">
              ...
              <h1 className="text-2xl md:text-3xl font-heading font-semibold leading-snug">
                ...
                <span className="text-[var(--color-primary)]">rotina</span>
              </h1>
            ...
            <div className="space-y-2 text-sm text-gray-300 md:pb-4 flex justify-evenly">
              <Link to="https://www.instagram.com" target="_blank" className="">
                <InstagramLogoIcon
                  size={40}
                  className="text-[var(--color-primary)] border border-[var(--color-primary)] rounded-md p-2 bg-[rgba(121,84,237,0.1)] backdrop-blur-sm hover:shadow-sm shadow-primary-400"
                />
                {/* Instagram */}
              </Link>
            ...
            >
              <div>
                ...
                <input
                  ...
                  className="w-full mt-1 text-black p-3 rounded-lg bg-gray-300 focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
                />
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full mt-1 p-3 text-black rounded-lg bg-gray-300 focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
                />
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="••••••"
                  className="w-full mt-1 p-3 rounded-lg text-black bg-gray-300 focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
                />
              ...
              {usuario.foto && usuario.foto.trim().length > 0 && (
                <div className="flex justify-center mb-4">
                  <div className="w-24 h-24 rounded-full border-2 border-[var(--color-primary)] overflow-hidden">
                    <img
                      src={usuario.foto}
                      alt="preview"
              ...
              <div className="flex gap-4 justify-around items-center m-auto">
                <div className="flex justify-center items-center border border-[var(--color-primary)] hover:bg-[var(--color-primary-light)] hover:text-black rounded-2xl w-40 h-15">
                  <motion.button
                    type="submit"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="w-full py-3 rounded-lg  font-semibold hover:bg-[var(--color-primary-hover)] transition"
                  >
                    {isLoading ? (
                ...
                <div className="flex justify-center items-center border border-[var(--color-primary)] hover:bg-red-500 hover:text-black rounded-2xl w-40 h-15">
                  <motion.button
                    type="button"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
