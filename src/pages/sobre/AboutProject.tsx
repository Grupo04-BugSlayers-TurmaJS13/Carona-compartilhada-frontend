      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div
          ...
          style={{
            ...
            right: "-8%",
            background:
              "radial-gradient(circle, rgba(101,163,13,0.10) 0%, transparent 70%)",
            filter: "blur(80px)",
            ...
            <div className="hero-inner">
              <div className="hero-text">
                ...
                <h1 className="hero-heading reveal reveal-delay-1">
                  Uma plataforma criada para <em>conectar pessoas</em>, rotas e
                  mobilidade elétrica sustentável.
                </h1>

                <p className="hero-body reveal reveal-delay-2">
                  O BipBip foi pensado pela nossa equipe para oferecer uma
                  experiência mais fluida no agendamento e acompanhamento de
                  caronas com carros elétricos, unindo interface moderna,
                  estrutura escalável e gestão orientada à mobilidade ecológica.
                </p>
                ...
                <div className="metrics-grid">
                  <article className="metric-card reveal reveal-delay-2">
                    ...
                    <p className="metric-detail">
                      Interface moderna com foco na responsividade, reutilização
                      de código e identidade visual consistente.
                    </p>
                  </article>
                  <article className="metric-card reveal reveal-delay-3">
                    ...
                    <p className="metric-detail">
                      Estrutura preparada para suportar fluxos de agendamento de
                      caronas de forma otimizada e escalável.
                    </p>
                  </article>
                  <article className="metric-card reveal reveal-delay-4">
                    ...
                    <p className="metric-detail">
                      Base relacional pensada para motoristas, passageiros,
                      rotas, agendamentos e histórico de viagens.
                    </p>
                  </article>
                </div>
              </div>
              ...
              <div className="mockup-header">
                <div>
                  ...
                  <h2 className="mockup-title">
                    Mockup conceitual da plataforma
                  </h2>
                </div>
                  ...
                  <article className="mockup-card">
                    ...
                    <div className="stats-row">
                      <div className="stat-box">
                        ...
                        <span className="stat-value" data-count="128">
                          0
                        </span>
                      </div>
                      <div className="stat-box">
                        <span className="stat-label">Confirmadas</span>
                        <span className="stat-value" data-count="76">
                          0
                        </span>
                      </div>
                      <div className="stat-box">
                        <span className="stat-label">Concluídas</span>
                        <span className="stat-value" data-count="24">
                          0
                        </span>
                      </div>
                    </div>
                  ...
                  <article className="mockup-card">
                    ...
                    <div className="focus-list">
                      <div className="focus-item">
                        <span className="focus-dot" /> Gestão de motoristas
                      </div>
                      <div className="focus-item">
                        <span className="focus-dot" /> Rotas e agendamentos
                      </div>
                      <div className="focus-item">
                        <span className="focus-dot" /> Impacto ambiental
                      </div>
                      <div className="focus-item">
                        <span className="focus-dot" /> Monitoramento de viagens
                      </div>
                    </div>
                  </article>
                </div>
                  ...
                  <div className="features-grid">
                    <div className="feature-card">
                      ...
                      <p className="feature-desc">
                        Acompanhe caronas agendadas, rotas ativas e passageiros
                        com uma leitura mais clara da mobilidade elétrica do seu
                        grupo.
                      </p>
                    </div>
                    <div className="feature-card">
                      ...
                      <p className="feature-desc">
                        Rotas, interface, requisições e persistência em um só
                        lugar! Pensadas para funcionar de forma integrada.
                      </p>
                    </div>
                    <div className="feature-card">
                      <div className="feature-icon">
                      ...
                      <p className="feature-desc">
                        A base do projeto permite crescer com novos módulos,
                        relatórios de emissão evitada e regras de agendamento.
                      </p>
                    </div>
                  </div>
                </article>
            ...
            <div className="tech-left reveal">
              <div>
                ...
                <h2 className="tech-heading">
                  Uma stack escolhida para entregar desempenho e crescimento.
                </h2>
                <p className="tech-body">
                  O projeto é uma junção de frontend moderno, backend modular e
                  ferramentas de colaboração para construir uma plataforma
                  sólida e preparada para evoluir.
                </p>
              </div>
